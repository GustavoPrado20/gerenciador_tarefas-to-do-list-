...
function validaCadastro(evt) {
	...
	if (senha.value == "") {
		...
		caixa_senha.innerHTML = "Minimo de 8 caracteres";
		caixa_senha.style.display = 'block';
		contErro += 1;
	} else {
	...
	if (senha2.value == "") {
		caixa_senha2.innerHTML = "Confirmação de senha vazio";
		caixa_senha2.style.display = 'block';
		contErro += 1;
	} else if (senha2.value.length < 8) {
		caixa_senha2.innerHTML = "Minimo de 8 caracteres";
		caixa_senha2.style.display = 'block';
		contErro += 1;
	} else {
	...
	if (senha.value != "" && senha2.value != "" && senha.value != senha2.value) {
		caixa_senha2.innerHTML = "As senhas sao diferentes";
		caixa_senha2.style.display = 'block';
		contErro += 1;
	}
